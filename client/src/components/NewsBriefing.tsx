    ...
    return (
      <div className={`p-4 md:p-5 ${wrapper}`}>
        <div className="mac-panel" style={{ textAlign: "center" }}>
          <h3 style={{ fontSize: "0.82rem", fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.15em", color: "var(--electric-blue)", marginBottom: "0.75rem" }}>News Briefing</h3>
          <p style={{ fontSize: "1rem", color: "var(--text-secondary)" }}>Select a headline to view a comprehensive briefing.</p>
        </div>
      </div>
    )
  }
      ...
      <div className={`p-4 md:p-5 ${wrapper}`}>
        <div className="mac-panel" style={{ padding: fullPage ? "1.75rem" : "1.25rem" }}>
          <div className="space-y-4">
            <div>
              <h3 style={{ fontSize: "0.82rem", fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.15em", color: "var(--electric-blue)", marginBottom: "0.5rem" }}>News Briefing</h3>
              <h4 className="article-title" style={{ fontWeight: 600 }}>{d.title}</h4>
            </div>

            <div>
                <h5 style={{ fontSize: "0.72rem", fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.12em", color: "var(--color-accent)", marginBottom: "0.35rem" }}>What Happened</h5>
                <ul style={{ paddingLeft: "1rem" }}>
                  {d.whatHappened.map((t: string, i: number) => (
                    <li key={i} style={{ fontSize: "0.95rem", lineHeight: 1.6, color: "var(--text-secondary)", marginBottom: "0.35rem", listStyle: "disc" }}>{t}</li>
                  ))}
                </ul>
              </div>
            ...
            {d.marketContext && d.marketContext.length > 0 && (
              <div>
                <h5 style={{ fontSize: "0.72rem", fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.12em", color: "var(--color-accent)", marginBottom: "0.35rem" }}>Market Context</h5>
                <ul style={{ paddingLeft: "1rem" }}>
            ...
            {d.keyTakeaways && d.keyTakeaways.length > 0 && (
              <div>
                <h5 style={{ fontSize: "0.72rem", fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.12em", color: "var(--color-accent)", marginBottom: "0.35rem" }}>Key Takeaways</h5>
                <ul style={{ paddingLeft: "1rem" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginTop: "1.25rem", paddingTop: "0.75rem", borderTop: "1px solid var(--glass-border)" }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "0.5rem" }}>
              <span style={{ fontSize: "0.68rem", color: "var(--text-tertiary)", textTransform: "uppercase", letterSpacing: "0.08em" }}>Helpful?</span>
              <button
